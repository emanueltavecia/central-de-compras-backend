...
// Importa o Service que acabamos de corrigir
...
  IdParamSchema,
  OrganizationSchema, // Usando OrganizationSchema para o filtro GET /
} from '@/schemas'
...
    query: OrganizationSchema, // Permite filtro por organizationId
    responses: {
...
    try {
      // Adaptação para o filtro organizationId no query
      const organizationId = req.query.organizationId as string | undefined
      
      const contacts = await this.contactsService.listContacts(organizationId)
